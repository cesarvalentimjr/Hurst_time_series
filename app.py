...
def main():
    ...
    ticker = st.sidebar.text_input("Ticker (ex: btc-usd - moedas e criptos, ^BVSP - índice, PETR$.SA - ações e ETFs da B3)", "btc-usd")
    ...
    if st.sidebar.button("Analisar"):
        with st.spinner("Carregando e processando dados..."):
            try:
                ...
                # Dados tabulares - CORREÇÃO FINAL APLICADA AQUI
